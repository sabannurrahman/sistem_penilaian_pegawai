...
class C_data_barang extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['title'] = 'Halaman Data Barang - ADMIN';
        $data['menu'] = '9';
        $data['menu_atas'] = '01';

        $this->load->view('admin/layout/header', $data);
        $this->load->view('admin/layout/sidebar', $data);
        $this->load->view('admin/data_barang/V_data_barang', $data);
    ...
    public function edit_brg($id)
    {
        ...
        $data['satuan'] = $this->db->query("SELECT * FROM tb_satuan")->result();
        $data['title'] = 'Halaman Edit Barang - ADMIN';
        $data['menu'] = '9';
        $data['menu_atas'] = '01';

        $this->load->view('admin/layout/header', $data);
        $this->load->view('admin/layout/sidebar', $data);
        $this->load->view('admin/data_barang/V_edit_barang', $data);
        $this->load->view('admin/layout/footer');
    }
