...
class C_rab extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['rab'] = $this->db->query("SELECT * FROM tb_rab rb, tb_perusahaan tp, tb_buyer tb WHERE tp.id_perusahaan=rb.id_perusahaan && tb.id_buyer=rb.id_buyer")->result();
        $data['title'] = 'Halaman Cetak RAB - ADMIN';
        $data['menu'] = '3';
        $data['menu_atas'] = '0';
        $this->load->view('admin/layout/header', $data);
        $this->load->view('admin/layout/sidebar', $data);
        $this->load->view('admin/data_rab/V_rab', $data);
