...
<body>
    ...
    <table class="tb" border="1" cellpadding="15" cellspacing="0">
        <tr>
            <td colspan=" 3"> <img src="<?= base_url('assets/'); ?>gambar/logo.png" alt="logo" width="60px" height="70px">

            </td>
        </tr>
        <tr>
            <td colspan="3" style="text-align: center;">Kasbon Operasional</td>
        </tr>
        <tr>
            <td colspan="3">
                <span>Tanggal : <?= tgl_indo($tanggal); ?></span><br>
                <span>Nomor : <?= tgl_indo($tanggal); ?></span>
