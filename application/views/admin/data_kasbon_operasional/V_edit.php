<div class="container-fluid">
    ...
    <h1 class="h3 mb-2 text-gray-800">Edit Kasbon operasional</h1>
        ...
        <div class="col-12 col-lg-12 col-sm-12">
            <div class="card shadow mb-4">
                <div class="card-header ">
                    Edit Isi Kasbon operasional
                </div>
                <?php foreach ($detail as $det) : ?>
                    <div class="card-body">
                        <form action="<?php echo base_url('admin/C_isi_kasbon_operasional/edit'); ?>" method="POST">
                            <input type="hidden" name="id_ko_detail" value="<?= $det->id_ko_detail; ?>">
                            <div class="mb-3">
